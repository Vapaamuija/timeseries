# Visual Regression Tests for Norwegian Meteogram

This directory contains comprehensive visual regression tests to ensure that the Norwegian meteogram plotter generates consistent, high-quality output that matches the reference diagram.
...
- **`test_norwegian_meteogram_visual.py`** - Main test suite with visual comparison logic
...
1. **`test_norwegian_meteogram_matches_reference`** - Main visual regression test
...
python -m pytest tests/test_norwegian_meteogram_visual.py -v

# Run specific test
python -m pytest tests/test_norwegian_meteogram_visual.py::TestNorwegianMeteogramVisual::test_norwegian_meteogram_matches_reference -v

# Run with detailed output
python -m pytest tests/test_norwegian_meteogram_visual.py -v -s
```
...
# Run specific test
python tests/run_visual_tests.py --test TestNorwegianMeteogramVisual::test_norwegian_meteogram_matches_reference
...
This visual testing framework ensures that the Norwegian meteogram plotter maintains consistent, high-quality output across code changes and system environments.
